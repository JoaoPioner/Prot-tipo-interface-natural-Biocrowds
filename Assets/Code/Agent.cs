...
namespace Biocrowds.Core
{
    public class Agent : MonoBehaviour
    {
        ...
        {
            Debug.Log("Eu sou: "+name+" do grupo "+group);
        }
        public void Set_GoalList(GameObject goal) {
            goalsList[0] = goal;
            goalIndex = 0;
        }
        ...
        private void UpdateGoalPositionAndNavmesh()
        {
            ...
            bool foundPath = NavMesh.CalculatePath(transform.position, goalsList[goalIndex].transform.position,NavMesh.AllAreas, _navMeshPath);
        ...
        public void WaitStep(float _timeStep)
        {
            ...
            else if (IsAtFinalGoal() && goalsList.Count>1) {
                goalIndex = 0;                
                UpdateGoalPositionAndNavmesh();
            }
        }
        ...
        internal void setGoalIndex(int v)
        {
            this.goalIndex = v;
        }
    }
